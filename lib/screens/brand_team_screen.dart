        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: SingleChildScrollView(
              ...
              CheckboxListTile(value: canManageCommunity, title: Text(_tx('brand_can_manage_community', 'Manage brand community')), onChanged: (value) => setDialogState(() => canManageCommunity = value == true)),
              CheckboxListTile(value: canManageCampaigns, title: Text(_tx('brand_can_manage_campaigns', 'Manage marketing campaigns')), onChanged: (value) => setDialogState(() => canManageCampaigns = value == true)),
              CheckboxListTile(value: canManageAds, title: Text(_tx('brand_can_manage_ads', 'Manage advertisements')), onChanged: (value) => setDialogState(() => canManageAds = value == true)),
              CheckboxListTile(value: canReplyMessages, title: Text(_tx('brand_can_reply_messages', 'Reply to messages')), onChanged: (value) => setDialogState(() => canReplyMessages = value == true)),
              CheckboxListTile(value: canViewAnalytics, title: Text(_tx('brand_can_view_analytics', 'View general analytics')), onChanged: (value) => setDialogState(() => canViewAnalytics = value == true)),
              CheckboxListTile(value: canRedeemRewards, title: Text(_tx('brand_can_redeem_rewards', 'Redeem rewards & QR')), onChanged: (value) => setDialogState(() => canRedeemRewards = value == true)),
                ],
              ),
            ),
          ),
