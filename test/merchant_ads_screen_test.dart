...
void main() {
  Widget buildTestableWidget({
    ...
    return MaterialApp(
      home: Scaffold(
        body: MerchantAdsTab(
          adsLoader: adsLoader,
          bannerSubmitter: (_) async {},
        ),
      ),
    );
  }

  testWidgets('MerchantAdsTab renders Light Theme headers and action buttons', (
    tester,
  ) async {
    await tester.pumpWidget(buildTestableWidget(adsLoader: () async => []));
  ...
  testWidgets('MerchantAdsTab displays interactive phone preview container', (
    tester,
  ) async {
  ...
  testWidgets(
    'MerchantAdsTab renders campaign table with CTR calculation and status toggle',
    (tester) async {
  ...
  testWidgets('Banner modal validates form fields before adding a banner', (
    tester,
  ) async {
    ...
    // Entering a title alone is not enough for a billboard request.
