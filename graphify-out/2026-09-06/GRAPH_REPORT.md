# Graph Report - source  (2026-09-04)

## Corpus Check
- 513 files · ~840,510 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4953 nodes · 6033 edges · 325 communities (299 shown, 26 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 194 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ab5bf024`
...
- coalition_dashboard_screen.dart
...
- create_private_coalition_dialog.dart
...
- brand_dashboard_screen_test.dart
...
3. `REWARDS / GIFTS / OFFERS: FINAL ARCHITECTURE VALIDATION + MIGRATION GATE REPORT` - 21 edges
4. `خطة تنفيذ كوبونا الشاملة (Kupuna Master Execution Plan)` - 21 edges
5. `سجل التنفيذ` - 19 edges
6. `PHASE 0 — PROJECT DISCOVERY REPORT` - 15 edges
7. `القسم 18-ج: مواصفات كل شاشة — تطبيق العميل (Customer App)` - 14 edges
8. `القسم 4: المحركات (Engine Layer) — بالتفصيل الكامل مع الصيغ والحالات` - 14 edges
9. `10) Completion Metrics (Category-Based)` - 14 edges
10. `main()` - 13 edges
...
## Communities (325 total, 26 thin omitted)

### Community 0 - "company_server_service.dart"
Cohesion: 0.01
Nodes (232): app_session.dart, acceptMerchantCoalitionInvitation, acceptMerchantReport, activateAdminSubscription, activatePublicCoalitionMembershipRequest, addBrandTeamMember, addMerchantBranchManager, _aiBaseUrl (+224 more)
...
Cohesion: 0.03
Nodes (65): FontWeight, color, height, kBadgeFontSize, kBadgePaddingHorizontal, kBadgePaddingVertical, kBodyFontFamily, kBodyTextStyle (+57 more)

### Community 3 - "win32_window.cpp"
Cohesion: 0.18
...
Cohesion: 0.04
Nodes (50): _blockUser, _broadcast, chatId, _cleanMessageText, _createPoll, createState, _deleteChat, dispose (+42 more)

### Community 7 - "GeneratedPluginRegistrant.swift"
Cohesion: 0.06
Nodes (30): Any, Cocoa, file_selector_macos, Flutter, FlutterAppDelegate, FlutterMacOS, FlutterPluginRegistry, FlutterViewController (+22 more)
...
Cohesion: 0.04
Nodes (57): ads_banner_slider.dart, action, _activeTab, _bannerIndex, _bannerKeys, _billboardAdsFuture, build, _buildBanner (+49 more)
...
Cohesion: 0.07
Nodes (28): _categories, _category, createState, _ctaType, _ctaValueController, _description, didChangeDependencies, _discountType (+20 more)
...
Cohesion: 0.06
Nodes (39): admin_dashboard_screen.dart, brand_dashboard_screen.dart, cashier_dashboard_screen.dart, _SectionCard, PrivacyScreen, _AccountSection, AppDrawer, _buildSettingsBody (+31 more)

### Community 20 - "VoidCallback"
Cohesion: 0.08
Nodes (21): AddInvoiceIcon, build, iconSize, onTap, build, KupunaOfferCard, offer, _OfferBadge (+13 more)
...
### Community 26 - "State"
Cohesion: 0.11
Nodes (27): AdminDashboardScreen, _AdminDashboardScreenState, BrandDashboardScreen, _BrandDashboardScreenState, CoalitionDashboardScreen, _CoalitionDashboardScreenState, CommunityScreen, _CommunityScreenState (+19 more)
...
Cohesion: 0.10
Nodes (20): dart:ui, foundation/app_logger.dart, GlobalKey, build, _checkConnection, createState, initState, _isOffline (+12 more)
...
Cohesion: 0.10
Nodes (16): Container, package:coupona_app/theme/app_themes.dart, package:coupona_app/theme/design_tokens.dart, package:coupona_app/widgets/design_system/kupuna_bottom_navbar.dart, package:coupona_app/widgets/design_system/kupuna_cashier_mode_screen_wrapper.dart, package:coupona_app/widgets/design_system/kupuna_chat_bubble.dart, package:coupona_app/widgets/design_system/kupuna_offer_card.dart, package:coupona_app/widgets/design_system/kupuna_status_pill.dart (+8 more)

### Community 32 - "offer_detail_screen.dart"
Cohesion: 0.11
Nodes (19): address, build, _buildMapCard, _buildOfferImage, createState, _extractLatLng, _getAddressFromLatLng, getEndDateText (+11 more)
...
### Community 34 - "kupuna_chat_bubble.dart"
Cohesion: 0.29
Nodes (6): build, ChatSenderKind, isCurrentUser, KupunaChatBubble, message, senderKind

### Community 35 - "package:flutter_test/flutter_test.dart"
Cohesion: 0.07
Nodes (20): dart:io, package:coupona_app/foundation/app_logger.dart, package:coupona_app/foundation/foundation_verifier.dart, package:coupona_app/modules/subscription/subscription_state_machine.dart, package:coupona_app/screens/my_rewards_screen.dart, package:flutter_test/flutter_test.dart, main, main (+12 more)
...
### Community 37 - "kupuna_bottom_navbar.dart"
Cohesion: 0.11
Nodes (17): activeItem, build, icon, item, _items, KupunaBottomNavbar, KupunaNavItem, label (+9 more)

### Community 38 - "package:image_picker/image_picker.dart"
Cohesion: 0.15
...
Cohesion: 0.11
Nodes (18): build, createState, _expandMap, initState, _localizeCategory, MapBar, _MapBarState, onExpand (+10 more)
...
### Community 52 - "export_download_web.dart"
Cohesion: 0.17
Nodes (10): dart:html, dart:typed_data, downloadBytes, false, anchor, blob, downloadBytes, true (+2 more)

### Community 53 - "wWinMain"
Cohesion: 0.24
Nodes (9): _In_, _In_opt_, vector, wWinMain(), string, wchar_t, CreateAndAttachConsole(), GetCommandLineArguments() (+1 more)

### Community 54 - "ledger_entry.dart"
Cohesion: 0.17
...
Cohesion: 0.17
Nodes (11): AccountingService, applyCashbackFromPurchase, ensureAccountingDocuments, redeemPoints, startWithFuture, watchLedgerEntries, watchPointAccount, watchWallet (+3 more)

### Community 57 - "points_screen.dart"
Cohesion: 0.25
Nodes (7): build, fetchPoints, fetchPointsHistory, PointsScreen, userId, package:fl_chart/fl_chart.dart, ../widgets/design_system/kupuna_dual_wallet_rings.dart
...
### Community 63 - "kupuna_status_pill.dart"
Cohesion: 0.10
Nodes (19): Color, AnalyticsMapPanel, build, emptyLabel, _initialZoom, markerColor, points, _toDouble (+11 more)
...
Cohesion: 0.22
Nodes (8): DateTime?, balance, currency, fromMap, ownerId, toMap, updatedAt, WalletAccount
...
### Community 77 - "activity_log_screen.dart"
Cohesion: 0.22
Nodes (9): activities, ActivityLogScreen, _ActivityLogScreenState, build, createState, customerEmail, fetchActivityLog, initState (+1 more)
...
### Community 79 - "rewards_screen.dart"
Cohesion: 0.25
...
Cohesion: 0.06
Nodes (22): AboutScreen, build, build, package:coupona_app/screens/brand_team_screen.dart, package:coupona_app/screens/cashier_dashboard_screen.dart, package:coupona_app/screens/merchant_dashboard_screen.dart, package:coupona_app/screens/report_issue_screen.dart, package:coupona_app/widgets/design_system/kupuna_dual_wallet_rings.dart (+14 more)

### Community 81 - "onboarding_screen.dart"
Cohesion: 0.14
Nodes (14): build, _controller, createState, _currentPage, _finishOnboarding, OnboardingScreen, _OnboardingScreenState, onFinish (+6 more)

### Community 82 - "point_account.dart"
Cohesion: 0.25
Nodes (7): availablePoints, fromMap, lifetimePoints, ownerId, PointAccount, toMap, updatedAt
...
### Community 88 - "users_list_screen.dart"
Cohesion: 0.25
Nodes (8): Future, build, createState, fetchUsers, initState, _usersFuture, UsersListScreen, _UsersListScreenState
...
Cohesion: 0.11
Nodes (16): analyzeInvoiceWithGemini(), buildInvoiceFingerprint(), { CANONICAL_ROLES }, canonicalMerchantName(), crypto, extractJsonObject(), https, INVOICE_RESPONSE_SCHEMA (+8 more)
...
### Community 97 - "coalition_gift_catalog_screen.dart"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (22): haversineDistanceKm(), normalizeMerchantKey(), parseTargetingCriteria(), toIso(), issueRaffleTicketsForInvoice(), analyticsPercentChange(), analyticsSafeNumber(), analyticsTopEntries() (+14 more)
...
Cohesion: 0.12
Nodes (16): getIntSetting(), applySubscriptionTransition(), canTransitionSubscription(), ensureCommunityMembership(), { FCM_SERVER_KEY }, getActivePushTokens(), { getIntSetting }, getSubscriptionOwnerUserId() (+8 more)
...
Cohesion: 0.12
Nodes (16): FormState, home_screen.dart, _authenticate, build, createState, dispose, _formKey, _loading (+8 more)
...
Cohesion: 0.06
Nodes (31): build, _buildEligibleStoresSelector, createState, _description, dispose, _eligibleStores, _evidenceBytes, _evidenceImage (+23 more)
...
Cohesion: 0.15
Nodes (12): القسم 10: نموذج البيانات الأساسي (Core Data Model), القسم 11: نموذج الربحية (Monetization), القسم 12: التقنيات المقترحة (Recommended Tech Stack), القسم 13: الحجم المتوقع والأداء والاستضافة, القسم 15: معايير القبول (Acceptance Criteria), القسم 16: خطة تنفيذ الـ Agent (Sprints), القسم 17: ملخص القرارات النهائية السريع (Quick Reference), القسم 3: قواعد العمل الأساسية (+4 more)
...
Cohesion: 0.07
Nodes (26): ../coupon_lifecycle_rules.dart, _StreamInit, CouponLifecycleService, ensureLifecycleDefaults, startWithFuture, _StreamInit, syncTemporalStatus, transitionOffer (+18 more)
...
### Community 170 - "coupon_lifecycle_rules.dart"
Cohesion: 0.25
...
### Community 193 - "create_private_coalition_dialog.dart"
Cohesion: 0.09
Nodes (23): _activityFilter, build, _buildFilterChip, _buildSuggestionsSection, CreatePrivateCoalitionDialog, _CreatePrivateCoalitionDialogState, createState, dispose (+15 more)

### Community 194 - "القسم 14: التصميم البصري وتجربة المستخدم"
Cohesion: 0.40
Nodes (5): 14.1 نظام الألوان حسب الدور, 14.2 نمط التنقل, 14.3 مبادئ تصميم الشاشات الحرجة, 14.4 اللغة والاتجاه, القسم 14: التصميم البصري وتجربة المستخدم
...
### Community 214 - "package:easy_localization/easy_localization.dart"
Cohesion: 0.09
Nodes (20): build, ReportIssueScreen, _showToast, AdminDrawer, build, currentRole, onSwitchRole, build (+12 more)

### Community 215 - "customer_coalitions_screen.dart"
Cohesion: 0.12
Nodes (16): ../dialogs/customer_redeem_coalition_gift_dialog.dart, action, build, _coalitionsFuture, createState, CustomerCoalitionsScreen, _CustomerCoalitionsScreenState, icon (+8 more)
...
Cohesion: 0.18
Nodes (11): build, _buildFlowClarification, _buildUsageGuide, createState, dispose, _loading, MerchantGiftTrigger, _MerchantGiftTriggerState (+3 more)
...
### Community 255 - "PHASE 2 — REWARDS / GIFTS / OFFERS: PRODUCTION IMPLEMENTATION REPORT"
Cohesion: 0.14
Nodes (13): 1. PRE-FLIGHT CHECK & ARCHITECTURE VERIFICATION (فحص ما قبل التنفيذ والتحقق المعماري), 2.1 Tables Created & Extended (قواعد البيانات), 2.2 APIs & Backend Services (الخدمات والخلفية), 2.3 Frontend & UI Cleanup (تحديثات الواجهة والتنظيف), 2. SUMMARY OF CHANGES & COMPONENTS (ملخص التغيرات والمكونات), 3. ARCHITECTURE DIAGRAM (مخطط المعمارية المعتمدة), 4.1 Automated Backend Test Suite (Node.js), 4.2 Flutter Widget & Integration Test Suite (+5 more)
...
### Community 264 - "kupuna_cashier_mode_screen_wrapper.dart"
Cohesion: 0.17
Nodes (11): _ActionButton, body, build, KupunaCashierModeScreenWrapper, label, onGrantPoints, onRedeemReward, onTap (+3 more)
...
### Community 270 - "pending-points-service.js"
Cohesion: 0.38
Nodes (5): id(), addTierPoints(), clearPendingPointsQueue(), convertExpiredPendingPoints(), { id }
...
### Community 274 - "degraded_local_mode_guard.dart"
Cohesion: 0.33
...
### Community 279 - "offers_list_screen.dart"
Cohesion: 0.25
Nodes (8): build, createState, fetchOffers, initState, _offersFuture, OffersListScreen, _OffersListScreenState, ../widgets/design_system/kupuna_offer_card.dart
...
Cohesion: 0.09
Nodes (20): build, _infoTile, store, StoreDetailsScreen, _value, build, createState, _error (+12 more)

### Community 294 - "team_invitations_screen.dart"
Cohesion: 0.12
Nodes (16): build, createState, _error, initState, _invitations, invitationsLoader, _load, _loading (+8 more)
...
### Community 300 - "src/access-control.js"
Cohesion: 0.09
Nodes (19): assert, { canRedeemClaim }, claimCreateHandler(), exchangeHandlers(), registerExchangeRewardsRoutes, test, auth(), canManageInvoice() (+11 more)

### Community 301 - "merchant_invoices_route_test.js"
Cohesion: 0.05
Nodes (28): assert, registerInvoicesRoutes, registerProductRoutes(), registerRewardsRoutes, routeCollector(), test, assert, {canManageInvoice} (+20 more)

### Community 302 - "brand_team_workflow_test.js"
Cohesion: 0.22
Nodes (4): assert, registerBrandTeamRoutes, routesFor(), test

### Community 303 - "cross_role_reports_screen_test.dart"
Cohesion: 0.29
Nodes (5): FilledButton, package:coupona_app/screens/customer_reports_screen.dart, package:coupona_app/screens/merchant_reports_screen.dart, main, main

### Community 304 - "package:latlong2/latlong.dart"
Cohesion: 0.33
...
### Community 309 - "role_requests_status_screen.dart"
Cohesion: 0.40
Nodes (4): build, _localizeRole, _localizeStatus, RoleRequestsStatusScreen

### Community 310 - "String?"
Cohesion: 0.40
Nodes (4): build, message, StreamLoadError, String?
...
## Knowledge Gaps
- **3347 isolated node(s):** `تقرير التثبت المعماري النهائي واعتماد الخط المرجعي للتنفيذ`, `1. VALIDATE THE PREVIOUS REPORT (التحقق والتثبت من القرارات والتقارير السابقة)`, `2. DEFINE THE FINAL CANONICAL ENTITIES (الكيانات الأساسية المعتمدة نهائيًا)`, `**لماذا لا يصلح `promo_campaign_coupons` كـ Assignment شامل؟**`, `4. FINAL GIFT MODEL (النموذج النهائي المعترف به للهدايا)` (+3342 more)
...
- **Why does `CouponLifecycleStatus` connect `coupon_lifecycle_rules.dart` to `coupon_lifecycle_record.dart`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **What connects `تقرير التثبت المعماري النهائي واعتماد الخط المرجعي للتنفيذ`, `1. VALIDATE THE PREVIOUS REPORT (التحقق والتثبت من القرارات والتقارير السابقة)`, `2. DEFINE THE FINAL CANONICAL ENTITIES (الكيانات الأساسية المعتمدة نهائيًا)` to the rest of the system?**
