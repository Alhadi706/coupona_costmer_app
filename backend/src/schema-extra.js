...
async function createExtraTables() {
  ...
  await pool.query('CREATE INDEX IF NOT EXISTS idx_community_offers_customer ON community_offers(customer_id, created_at DESC)');
  await pool.query('CREATE INDEX IF NOT EXISTS idx_community_offers_cat_status ON community_offers(category, status, created_at DESC)');
  await pool.query('CREATE INDEX IF NOT EXISTS idx_community_offers_scope_status ON community_offers(visibility_scope, status, created_at DESC)');
